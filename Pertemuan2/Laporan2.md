#
# <p align ="center"> LAPORAN PRAKTIKUM ALGORITMA DAN STRUKTUR DATA 2 </p>
...
2.1.2 Verifikasi Hasil Percobaan <br>
...
Jawab :
- Class adalah sebuah konsep abstrak yang tidak dapat diakses secara langsung oleh program. Class hanya dapat diwujudkan melalui pembuatan objek. Class juga dapat dianggap sebagai sebuah tipe data yang dapat dibuat sendiri oleh programmer . <br>
...
#
# 2.2 Percobaan 2: Instansiasi Object, serta Mengakses Atribut dan Method <br>
2.2.1 Langkah-langkah Percobaan
![alt text](img/code2.png)

2.2.2 Verifikasi Hasil Percobaan <br>
![alt text](<img/Screenshot 2024-02-21 141134.png>)
...
2.3.2 Verifikasi Hasil Percobaan <br>
![alt text](<img/Screenshot 2024-02-21 144954.png>)
...
![alt text](<img/Screenshot 2024-02-21 151100.png>)
...
2. Soal 2 
Jawab :
![alt text](img/code8.png) <br>
Hasil program <br>
![alt text](<img/Screenshot 2024-02-27 175312.png>)